...
<form method="POST" action="../src/traitement/AjoutMedecinTrt.php">
    <div class="form-group">
        <label>Spécialité :</label>
        <select name="ref_specialite" required>
            <option value="">-- Sélectionner --</option>
            <?php foreach ($specialites as $s): ?>
                <option value="<?= $s['id_specialite'] ?>"><?= htmlspecialchars($s['libelle']) ?></option>
            <?php endforeach; ?>
        </select>
    </div>
    ...
    <div class="form-group">
        ...
        <select name="ref_hopital" required>
            ...
            <?php foreach ($hopitaux as $h): ?>
                <option value="<?= $h['id_hopital'] ?>"><?= htmlspecialchars($h['nom']) ?></option>
            <?php endforeach; ?>
        </select>
    </div>
    ...
    <div class="form-group">
        ...
        <select name="ref_etablissement" required>
            ...
            <?php foreach ($etablissements as $e): ?>
                <option value="<?= $e['id_etablissement'] ?>"><?= htmlspecialchars($e['nom_etablissement']) ?></option>
            <?php endforeach; ?>
        </select>
    </div>
